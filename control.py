...
def print_help():
    ...
    print('                                          cx, cy and cz - camera position relative to the bus')
    ...
    print('busnpcs keep|reset_interval value     - number of bus NPCs to keep in environment')
    print('                                        and bus reset interval - int')
